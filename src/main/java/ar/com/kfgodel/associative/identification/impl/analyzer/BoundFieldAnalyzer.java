package ar.com.kfgodel.associative.identification.impl.analyzer;
...
public class BoundFieldAnalyzer implements Analyzer {
    ...
    public Nary<Object> analyse(Object entity) {
        ...
        ArrayList<Object> parts = Lists.newArrayList(origin, UninterpretableRepresentationImpl.INSTANCE, destination);
