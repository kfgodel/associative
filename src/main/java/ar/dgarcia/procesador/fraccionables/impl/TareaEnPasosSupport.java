...
public class TareaEnPasosSupport<R> extends TareaParticionableSupport<R> implements TareaConPadre<R> {
	...
	/**
	 * @see ar.dgarcia.procesador.fraccionables.impl.TareaParticionableSupport#ejecutarCon(ar.dgarcia.procesador.fraccionables.api.ProcesadorDeTareasParticionables)
	 */
	@Override
	...
	/**
	 * @see ar.dgarcia.procesador.fraccionables.impl.TareaParticionableSupport#prepararRecursos()
	 */
	@Override
